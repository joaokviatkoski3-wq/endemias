...
class MainPagesSmokeTests(unittest.TestCase):
    ...
    def test_pagina_ovitrampas_exibe_edicao_em_lote(self):
        ...
        self.assertIn('id="ovi-mon-localidades"', html)
        self.assertIn('id="ovi-mon-ovitrampas"', html)
        self.assertIn('data-multi-picker', html)
        self.assertIn('/api/ovitrampas/monitoramento/opcoes-armadilhas?', html)
...
class MainApisSmokeTests(unittest.TestCase):
    ...
    def test_pagina_esporotricose_exibe_abas_principais(self):
        ...
        self.assertIn("doe-kpi-tratamento", html)
        self.assertIn("doe-status-kpis", html)
        self.assertIn("renderEspDoentesStatusKpis", html)
