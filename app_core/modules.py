...
MODULES: Tuple[AppModule, ...] = (
    ...
    AppModule(
        ...
        icon="fichario.svg",
        nav_section="Analise",
        description="Consolidado SisPNCD e contingencia do boletim TBO manual.",
        tags=("SisPNCD", "TBO"),
    ),
    AppModule(
        key="ovitrampas",
    ...
    AppModule(
        key="acoes_setor",
        title="Ações e Atendimentos",
        href="/acoes-setor",
        endpoint="acoes_setor.page",
        icon="acoes_setor.svg",
        nav_section="Gestao",
        description="Registro de ações coletivas, atendimentos técnicos e articulações do setor.",
        tags=("Atendimentos", "Palestras", "Mutirões", "Vistorias"),
        min_level="operador",
    ...
    AppModule(
        key="processar",
        title="Importacao Kobo",
        short_title="Importacao Kobo",
        href="/processar",
        endpoint="processar.processar_page",
        icon="pasta.svg",
        nav_section="Administracao",
        description="Importacao por API Kobo e upload emergencial de planilhas exportadas do KoboToolbox.",
        tags=("Kobo", "API", "ETL"),
        min_level="admin",
    ...
    AppModule(
        ...
        icon="usuarios.svg",
        nav_section="Administracao",
        description="Cadastro de servidores, situacao funcional e dados administrativos.",
        tags=("Admin", "Servidores"),
        min_level="admin",
