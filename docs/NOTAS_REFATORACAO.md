...
- Versao atual: `1.7.0` (`julho/2026`), com estoque de esporotricose, mapa analitico do RG, backups no disco D, filtros modernos e melhorias de edicao/visualizacao.
