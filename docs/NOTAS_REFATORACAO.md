...
- Versao atual: `1.9.1` (`julho/2026`), com estoque de esporotricose, mapa analitico do RG, backups no disco D, filtros modernos, melhorias de edicao/visualizacao, Diarios de Ovitrampas, historico de alteracoes das armadilhas e leitura laboratorial de ovitrampas.
