...
- Versao atual: `1.10.0` (`julho/2026`), com estoque de esporotricose, mapa analitico do RG, backups no disco D, filtros modernos, melhorias de edicao/visualizacao, Diarios de Ovitrampas, leitura laboratorial de ovitrampas, ampliacao de Acoes e Atendimentos e reforcos de integridade do SQLite e dos backups.
