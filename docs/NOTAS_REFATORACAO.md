...
- Versao atual: `1.11.1` (`julho/2026`), com estoque de esporotricose, mapa analitico do RG, backups no disco D, filtros modernos, melhorias de edicao/visualizacao, Diarios de Ovitrampas, leitura laboratorial de ovitrampas, Acoes e Atendimentos com acervo historico incorporado e reforcos de integridade do SQLite e dos backups.
