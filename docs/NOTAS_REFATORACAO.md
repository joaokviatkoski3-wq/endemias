...
- Versao atual: `1.9.3` (`julho/2026`), com estoque de esporotricose, mapa analitico do RG, backups no disco D, filtros modernos, melhorias de edicao/visualizacao, Diarios de Ovitrampas, leitura laboratorial de ovitrampas, reformulacao das Acoes do Setor e reforcos de integridade do SQLite e dos backups.
